...
import { GET_USER_DETAILS } from "../../constant/constants"
                ...
                <div className="flex max-xl:flex-col w-full justify-between">
                  ...
                  >
                    ...
                    <div className="flex items-center mt-[23px] ">
                      ...
                      <span className="ml-[13px]">31/12/2022</span>
                  ...
                  >
                    <div className="flex items-center">
                      <div className="ml-[13px]">
                        ...
                        <span>Time: 10:00pm</span>
                      </div>
                    </div>
                    <div className="flex items-center mt-[3.2rem] max-xl:mt-4">
                    <span className="ml-[13px]">Date: 31/12/2022</span>
                  ...
                  >
                    <div className="flex items-center justify-center ">
                      <span className="font-bold text-[20px]">
                        {/* ${booking.bookingRate} */} $ 13930
                      </span>
                    </div>

                    <div
                      className={`flex flex-col justify-center max-xl:mt-4 max-xl:mb-4 items-center` } 
                    //   ${
                    //     booking.status ||
